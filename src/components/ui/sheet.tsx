...
function SheetOverlay({ className, ...props }: SheetPrimitive.Backdrop.Props) {
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn(
        'data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 fill-mode-forwards data-closed:duration-300 data-open:duration-500 fixed inset-0 z-50 bg-black/50',
        className
      )}
      {...props}
    />
