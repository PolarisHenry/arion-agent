  ...
  return (
    <div className='space-y-3'>
      ...
      <div className='grid gap-3'>
        ...
        <div>
          <p className='text-muted-foreground text-xs font-medium uppercase'>{t('Category')}</p>
          <p className='text-sm capitalize'>{values.category || '—'}</p>
        </div>
        <div>
          <p className='text-muted-foreground text-xs font-medium uppercase'>{t('Price')}</p>
          <p className='text-sm'>{values.price != null ? `$${values.price}` : '—'}</p>
        </div>
        <div>
          <p className='text-muted-foreground text-xs font-medium uppercase'>{t('Description')}</p>
        ...
        <div className='flex flex-col gap-2 pt-3'>
          <div className='flex flex-col items-center justify-start gap-1'>
            <span className='text-muted-foreground text-sm'>
              {t('Step')} {currentStep} {t('of')} {Object.keys(groups).length}
            </span>
