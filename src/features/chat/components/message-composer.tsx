...
export function MessageComposer({
  ...
  return (
    <form onSubmit={onSubmit} className='space-y-2 sm:space-y-3' aria-label={t('Reply composer')}>
      ...
      <div className='border-border/40 bg-background/80 flex items-end gap-2 rounded-2xl border p-3 backdrop-blur sm:gap-3 sm:rounded-3xl sm:p-4'>
        <div className='min-w-0 flex-1'>
          ...
          <Textarea
            ...
            placeholder={
              t('Message') + ' ' + contactName + t(' (Enter to send, Shift+Enter for newline)')
            }
            rows={2}
            ...
            aria-label={t('Message') + ' ' + contactName}
          />
