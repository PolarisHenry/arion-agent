  ...
  return (
    <div className='border-border/40 bg-background/75 hidden h-full flex-col gap-4 overflow-hidden rounded-2xl border p-3 backdrop-blur lg:col-start-1 lg:col-end-2 lg:flex lg:rounded-3xl lg:p-4'>
      <div className='flex items-center justify-between gap-3'>
        <div>
          <p className='text-foreground text-sm font-semibold'>{t('Messenger')}</p>
          <p className='text-muted-foreground text-xs'>
            {conversations.length} {t('active conversation(s)')}
          </p>
        </div>
        <Badge
          variant='outline'
            ...
            >
              <div className='relative shrink-0'>
                ...
                <span
                  ...
                  aria-label={conversation.status === 'online' ? t('Online') : t('Offline')}
                />
              </div>
