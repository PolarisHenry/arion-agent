...
export function PokemonInfo() {
  ...
  return (
    <div className='space-y-6'>
      ...
      <Card>
        <CardHeader>
          <CardTitle>{t('Pick a Pokemon')}</CardTitle>
          <CardDescription>
            {t(
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {t('Height:')} {data.height / 10}m &middot; {t('Weight:')} {data.weight / 10}kg
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter>
          <p className='text-muted-foreground text-xs'>
            {t('Data from PokeAPI')} &middot; {t('Prefetched on server, hydrated on client')}
          </p>
        </CardFooter>
      </Card>
    </div>
